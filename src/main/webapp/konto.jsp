...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <ul> ${ sessionScope['bank.kontennamenListe'] } </ul>
            ...
            <form method="POST" action="LogoutServlet">
                ...
                er dar�ber identifiziert und abgemeldet werden kann. Die Email deshalb, weil sie im Gegensatz
                zum Namen eines Kunden einzigartig sein MUSS -->
                <input type="hidden" name="email" value="${ sessionScope.kunde.getEmail() }" />
            </form>

            <h2>Kontostand.csv Datei hochladen</h2>
        </div>
